...
slaves.sh /usr/hdp/2.3.4.0-3485/hadoop/sbin/hadoop-daemon.sh --script hdfs start datanode

yarn-daemon.sh start resourcemanager
slaves.sh /usr/hdp/2.3.4.0-3485/hadoop-yarn/sbin/yarn-daemon.sh start nodemanager
